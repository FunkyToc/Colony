...
summon minecraft:armor_stand ~ ~ ~ {Tags:["vorager"],Pose:{RightArm:[0f,0f,08f]},HandItems:[{id:"minecraft:kelp",Count:1b,tag:{vorager:true}},{}],NoGravity:1b,Small:1b,Invisible:1b,Marker:1b,Silent:1b}
# reproduce x2
