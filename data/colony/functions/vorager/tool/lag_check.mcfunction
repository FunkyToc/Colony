...
execute if score vora_count Insect_Option > vora_maxcount Insect_Option run function colony:vorager/tool/lag_clear_vorager
...
execute if score vora_nest Insect_Option > vora_maxnest Insect_Option run function colony:vorager/tool/lag_clear_nest